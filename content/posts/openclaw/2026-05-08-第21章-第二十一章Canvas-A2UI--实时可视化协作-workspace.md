---
title: "第二十一章：Canvas A2UI —— 实时可视化协作 workspace"
date: 2026-05-08
...
- 第二十一章：Canvas A2UI —— 实时可视化协作 workspace 👈 当前位置
- [第二十二章：语音唤醒 (Voice Wake) —— 语音交互体验](./22-voice-wake.md) 👉 下一章
- [第二十三章：WebChat —— Gateway WebSocket 聊天界面](./23-webchat.md)

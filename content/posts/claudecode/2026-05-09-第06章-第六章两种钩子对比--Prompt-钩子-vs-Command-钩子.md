---
title: "第06章 第六章：两种钩子对比 —— Prompt 钩子 vs Command 钩子"
date: 2026-05-09
category: "02 core"
tags: []
...
- [第五章：Hooks 系统 —— 事件驱动的自动化引擎](./05-hooks-system.md)
- 第六章：两种钩子对比 —— Prompt 钩子 vs Command 钩子 👈 当前位置
- [第七章：插件架构 —— 目录结构、自动发现与清单](./../03-plugins/07-plugin-architecture.md) 👉 下一章
